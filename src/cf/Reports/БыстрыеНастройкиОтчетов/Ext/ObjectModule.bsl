...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	КомпоновщикНастроек.ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("ОтчетПустой", ТаблицаЗначений.Количество() = 0);
КонецПроцедуры
...
Функция ПроанализироватьПользовательскиеНастройки(КомпоновщикНастроекКД, ОтчетСсылка, КлючВарианта, ОтчетОбъект)
	...
	ОтчетыСервер.ОчиститьРасширеннуюИнформациюОНастройках(Анализ);
...
Функция ПоУмолчаниюВсеПодключеныКХранилищу()
	...
	Возврат (Метаданные.ХранилищеВариантовОтчетов <> Неопределено
		И МетаданныеХранилища.Имя = "ХранилищеВариантовОтчетов");
КонецФункции
