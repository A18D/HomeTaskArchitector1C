...
//	Параметры
//		МетаданныеИсточник - или общие реквизиты, или метаданные табличных частей
...
// Возвращает структуру реквизитов метаданных
// исключая
//		- стандартные реквизиты Ссылка,Предопределенный,ПометкаУдаления,ЭтоГруппа
//		- реквизиты типа ХранилищеЗначения
