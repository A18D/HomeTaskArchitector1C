...
Процедура ЗапуститьОбновлениеДоступаОбработчикОжидания()
	...
	ЗапуститьОбновлениеДоступаНаСервере();
	
КонецПроцедуры

&НаСервереБезКонтекста
Процедура ЗапуститьОбновлениеДоступаНаСервере()
	
	УправлениеДоступомСлужебный.ЗапуститьОбновлениеДоступаНаУровнеЗаписей(Истина);
...
Процедура ОбновитьТекстыОграниченияСпискаДляВидаПользователей(Свойства, ДляВнешнихПользователей, ДополнительныеПараметры)
	...
	Если ЗначениеЗаполнено(Свойства.ТекстОшибокОграничения)
		...
		ХранимыеСвойства.ТекстОграниченияВРоли = НСтр("ru = '<Ограничение для роли не рассчитано - нажмите Рассчитать>'");
