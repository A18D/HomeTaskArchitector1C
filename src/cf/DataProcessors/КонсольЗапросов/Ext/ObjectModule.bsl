...
КонецФункции // ВерсияПриложенияЧисло()
...
Функция ПараметрыОбработкиКонфигурационногоФайла()
	...
	ПараметрыОбработки.Вставить("ТекущееСостояниеТЖ", Неопределено);
...
КонецПроцедуры //СобратьКаталогиТЖПоУзламКонфигурации()
...
КонецФункции // ПрочитатьТекстДоТега()

Функция ЗаписатьКонфигурациюВФайл(СтруктураФайлаКонфигурации, ПараметрыФайлаКонфигурации, РезультатВключения, Записывать)
...
КонецФункции // ЗаписатьКонфигурациюВФайл()
...
КонецФункции // ШаблоныТеговКонсоли()
...
КонецФункции // БлокКонфигурацииСеанса()
...
Функция СеансКонсолиЗапросовНеактивен(ФильтрТекущегоСеанса, ФильтрыСобытияТЖ)
	...
	СеансыТекущейБазы = ПолучитьСеансыИнформационнойБазы();
