...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ОбновляемыеОбъекты.Добавить(УправлениеСвойствами.НаборСвойствПоИмени("Справочник__ДемоКонтрагенты"));
	ОбновляемыеОбъекты.Добавить(Справочники.НаборыДополнительныхРеквизитовИСведений.УдалитьУдалитьСправочник__ДемоКонтрагенты);
	ОбновляемыеОбъекты.Добавить(УправлениеСвойствами.НаборСвойствПоИмени("Справочник_ДемоКонтрагенты_Основное"));
	...
	Запрос.УстановитьПараметр("Ссылка", Справочники.НаборыДополнительныхРеквизитовИСведений.УдалитьУдалитьСправочник__ДемоКонтрагенты);
	...
	Если ДополнительныеРеквизитыГруппы.Количество() = 0 И ДополнительныеСведенияГруппы.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	НаборСсылка = УправлениеСвойствами.НаборСвойствПоИмени("Справочник_ДемоКонтрагенты_Основное");
	...
	НаборСсылка = УправлениеСвойствами.НаборСвойствПоИмени("Справочник__ДемоКонтрагенты");
	НаборОбъект = НаборСсылка.ПолучитьОбъект();
	...
	УстаревшийНабор = Справочники.НаборыДополнительныхРеквизитовИСведений.УдалитьУдалитьСправочник__ДемоКонтрагенты;
