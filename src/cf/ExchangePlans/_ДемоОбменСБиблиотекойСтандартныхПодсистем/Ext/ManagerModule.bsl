...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ИдентификаторНастройки = "ТолькоПолучение" Тогда
		...
		|Принимаются следующие типы данных: справочники (например, ""Организации""), документы (например, ""Реализация товаров""), регистры сведений (например, ""Курсы валют""), план видов характеристик ""Дополнительные реквизиты и сведения"", а также константы.'");
	ИначеЕсли ИдентификаторНастройки = "Двухсторонний" Тогда
		...
		|В синхронизации участвуют следующие типы данных: справочники (например, ""Организации""), документы (например, ""Реализация товаров""), регистры сведений (например, ""Курсы валют""), план видов характеристик ""Дополнительные реквизиты и сведения"", а так же константы. 
		|Синхронизация является двухсторонней и позволяет иметь актуальные данные в каждой из программ.'");
	КонецЕсли;
	
	ПодробнаяИнформацияПоОбмену = ?(ОбщегоНазначения.РазделениеВключено(),
		"https://its.1c.ru/bmk/bsp/synch_prog",
		"ПланОбмена._ДемоОбменСБиблиотекойСтандартныхПодсистем.Форма.ПодробнаяИнформация");
	...
	Если ИдентификаторНастройки = "ТолькоПолучение" Тогда
		...
		ЗаголовокКоманды   = НСтр("ru = 'Получение данных из ""1С:Библиотека стандартных подсистем""'");
	...
	ИначеЕсли ИдентификаторНастройки = "Двухсторонний" Тогда
		...
		ЗаголовокКоманды   = НСтр("ru = 'Полная синхронизация данных с ""1С:Библиотека стандартных подсистем""'");
