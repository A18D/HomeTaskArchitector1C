...
Процедура ПриОпределенииПараметровГруппыИндикации(ПараметрыГруппыИндикации, ТипСсылки) Экспорт
	...
	Если ТипСсылки = Тип("ДокументСсылка._ДемоНачислениеЗарплаты") Тогда
...
////////////////////////////////////////////////////////////////////////////////
// Обработчики начального заполнения
...
Процедура ПриНачальномЗаполненииРолейИсполнителей(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.КраткоеПредставление             = НСтр("ru = '000000005'");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Главный бухгалтер'",КодыЯзыков); // @НСтр
	...
	Элемент.КраткоеПредставление             = НСтр("ru = '000000002'");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Руководитель компании'", КодыЯзыков); // @НСтр
	...
	Элемент.КраткоеПредставление             = НСтр("ru = '000000003'");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Руководитель подразделения'", КодыЯзыков); // @НСтр
	...
	Элемент.КраткоеПредставление             = НСтр("ru = '000000004'");
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Руководитель проекта'", КодыЯзыков); // @НСтр
...
Процедура ПриНачальномЗаполненииОбъектовАдресацииЗадач(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Организация'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Подразделение'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование",
		"ru='Демо: Проект'", КодыЯзыков); // @НСтр
...
Процедура ПриЗаполненииРеквизитовОрганизацииВЗаявленииНаСертификат(Параметры) Экспорт
	...
	ВидыКИ.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("_ДемоФактическийАдресОрганизации"));
	...
	Строка = КонтактнаяИнформация.Найти(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("_ДемоФактическийАдресОрганизации"), "Вид");
	Если Строка <> Неопределено Тогда
