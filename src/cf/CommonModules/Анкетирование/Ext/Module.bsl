...
Процедура ПостроениеФормыЗаполненияПоРазделу(Форма,ТекущиеДанныеДеревоРазделов) Экспорт
	...
	Если ТекущиеДанныеДеревоРазделов.ТипСтроки = "Раздел" Тогда
		...
		Форма.Элементы.НадписьВступление.ЦветТекста =  ЦветаСтиля.ЦветРазделаПанелиФункций;
		Форма.Элементы.НадписьВступление.Шрифт = ШрифтыСтиля.КрупныйШрифтТекста;
	...
	Иначе
		...
		Форма.Элементы.НадписьВступление.Шрифт = ШрифтыСтиля.МелкийШрифтТекста;
