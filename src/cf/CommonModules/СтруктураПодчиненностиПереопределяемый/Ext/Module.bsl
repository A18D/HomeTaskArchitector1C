...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Реквизиты = Новый Соответствие;
	Реквизиты.Вставить("СуммаДокумента", Метаданные.Документы._ДемоСчетНаОплатуПокупателю.Реквизиты.СуммаОплаты.Имя);
	Реквизиты.Вставить("Валюта", Метаданные.Документы._ДемоСчетНаОплатуПокупателю.Реквизиты.ВалютаДокумента.Имя);
	Настройки.Реквизиты.Вставить(Метаданные.Документы._ДемоСчетНаОплатуПокупателю.ПолноеИмя(), Реквизиты);
	
	МетаданныеДоговоров = Метаданные.Справочники._ДемоДоговорыКонтрагентов; // ОбъектМетаданныхСправочник
	
	РеквизитыДляПредставления = Новый Массив;
	РеквизитыДляПредставления.Добавить(МетаданныеДоговоров.СтандартныеРеквизиты.Наименование.Имя);
	РеквизитыДляПредставления.Добавить(МетаданныеДоговоров.Реквизиты.НомерДоговора.Имя);
	РеквизитыДляПредставления.Добавить(МетаданныеДоговоров.Реквизиты.ДатаДоговора.Имя);
	Настройки.РеквизитыДляПредставления.Вставить(МетаданныеДоговоров.ПолноеИмя(), РеквизитыДляПредставления);
