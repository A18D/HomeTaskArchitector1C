...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.РегистрыСведений.СоставыГруппПользователей, Истина);
...
//                     - Массив Из возвращаемое значение - заполняет массив пользователями
//                       для которых есть изменения.
//
//  ИзмененныеГруппы   - Неопределено - никаких действий.
//                     - Массив Из возвращаемое значение - заполняет массив группами пользователей
//                       для которых есть изменения.
//
...
//
//  УчастникиИзменений - Массив Из возвращаемое значение - заполняет массив пользователями или
//                       внешними пользователями, для которых есть изменения.
//
//  ИзмененныеГруппы   - Массив Из возвращаемое значение - заполняет массив группами пользователей или
...
//
//  УчастникиИзменений  - Неопределено - никаких действий.
//                      - Массив Из возвращаемое значение - заполняет массив внешними
//                        пользователями для которых есть изменения.
//
//  ИзмененныеГруппы   - Неопределено - никаких действий.
//                     - Массив Из возвращаемое значение - заполняет массив группами внешних
...
Процедура ЗаполнитьНазначениеГруппВнешнихПользователей() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ГруппаОбъект.Предопределенный Тогда
			ПустыеСсылки = ПользователиСлужебныйПовтИсп.ПустыеСсылкиТиповОбъектовАвторизации();
			Для Каждого ПустаяСсылка Из ПустыеСсылки Цикл
...
Процедура ПроверитьПраваПользователя(ПользовательИБ, РежимПроверки, ЭтоВнешнийПользователь)
	...
	// Для запуска юнит-тестов под внешними пользователями.
	Если ЭтоВнешнийПользователь И РежимПроверки = "ПриЗапуске" Тогда
		Возврат;
	КонецЕсли;
	// _Демо конец примера
