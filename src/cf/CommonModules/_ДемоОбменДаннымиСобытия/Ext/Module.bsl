...
Процедура ПроверкаНегативногоСценария(УзелКорреспондента, НегативныйСценарий = "", ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если НегативныйСценарий = "ОшибкаПроверкиЗаполнения"
	...
	Если НегативныйСценарий = "ОшибкаОбработчикаПОД"
		Или НегативныйСценарий = "ОшибкаОбработчикаПКО" Тогда
		Результат = 10 / 0;
	КонецЕсли;
	
	Если НегативныйСценарий = "ПроверкаЗначенияНаСоответствиеФасетуПеречисления" Тогда
